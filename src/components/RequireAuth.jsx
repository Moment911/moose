...
const PUBLIC_ROUTES = ['/login', '/signup', '/welcome', '/portal', '/review', '/onboard', '/onboarding', '/client-auth', '/privacy', '/public', '/uptime/public', '/status', '/encyclopedia']
    ...
    <>
      {loading && (
        <div style={{
          ...
          <Loader2 size={32} color='#cb1c6b' style={{ animation:'spin 1s linear infinite' }}/>
