...
function VDMBadge({ score, label }) {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '8px 16px' }}>
      <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 24, fontWeight: 900, color, lineHeight: 1 }}>{score ?? '—'}</div>
    ...
    return (
      <div>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <div>
            <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 18, fontWeight: 800, color: BLK }}>Content Calendar & Publishing Momentum</div>
        ...
        <div style={{ ...card, textAlign: 'center', padding: '48px 24px' }}>
          ...
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 8 }}>No content calendar yet</div>
  ...
  return (
    <div>
          ...
          <div style={card}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 12 }}>
              <div>
                ...
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 24, fontWeight: 900, color: BLK }}>{momentum.pages_this_month}</div>
              </div>
              <div>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase' }}>Last Month</div>
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 24, fontWeight: 900, color: BLK }}>{momentum.pages_last_month}</div>
              </div>
              <div>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase' }}>3mo Avg</div>
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 24, fontWeight: 900, color: BLK }}>{momentum.pages_3mo_avg}</div>
              </div>
            </div>
      ...
      {momentum?.recommended_pace && (
        <div style={{ ...card, marginBottom: 20, borderColor: T + '50', background: '#f9f9fb' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 13, fontWeight: 700, color: BLK, marginBottom: 4 }}>AI Recommendation</div>
      ...
      <div style={{ ...card, marginBottom: 20 }}>
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 12 }}>Publishing Pace (Last 6 Months)</div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #ececef', background: GRY }}>
              <th style={{ padding: '10px 16px', textAlign: 'left', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Title</th>
              <th style={{ padding: '10px 12px', textAlign: 'left', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Keyword</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Type</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Status</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Date</th>
              <th style={{ padding: '10px 12px', textAlign: 'left', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase' }}>Assigned</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, fontSize: 11, color: '#1f2937', textTransform: 'uppercase', width: 60 }}>Edit</th>
            </tr>
          </thead>
          <tbody>
            {filteredItems.length === 0 && (
              <tr><td colSpan={7} style={{ padding: 32, textAlign: 'center', color: '#1f2937' }}>No items match filters</td></tr>
            )}
                  ...
                  <td style={{ padding: '10px 12px', textAlign: 'center' }}>
                    {isEditing ? (
                      ...
                      <button onClick={() => { setEditingId(item.id); setEditValues({}) }} style={{
                        padding: '4px', borderRadius: 4, border: 'none', background: 'none', cursor: 'pointer', color: '#1f2937',
                      }}>
                        <Edit2 size={13} />
                      </button>
                    )}
