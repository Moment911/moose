  ...
  return (
    <div style={{ background: '#f9f9fb', borderRadius: 12, padding: '16px 18px', border: '1px solid #ececef' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
        ...
        <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase', letterSpacing: '.05em', fontFamily: DESIGN.fonts.body }}>{label}</div>
      </div>
      <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 32, fontWeight: 900, color, lineHeight: 1 }}>{score ?? '—'}</div>
  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 28 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 22, fontWeight: 800, color: BLK, marginBottom: 4 }}>Topical Authority Score</div>
      ...
      {!data && !running && (
        <div style={{ ...card, textAlign: 'center', padding: 48 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No Authority Audit Yet</div>
