  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 60 }}>
        ...
        <span style={{ marginLeft: 10, fontFamily: DESIGN.fonts.body, fontSize: 14, color: '#6b6b70' }}>Loading goals…</span>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK }}>Agent Goals</div>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={loadGoals} style={{
            ...
            cursor: 'pointer', color: BLK, fontFamily: DESIGN.fonts.body,
          }}>
          ...
          <button onClick={() => setShowNewGoal(true)} style={{
            ...
            cursor: 'pointer', fontFamily: DESIGN.fonts.body,
          }}>
      ...
      {goals.length === 0 && (
        <div style={{ ...card, textAlign: 'center', padding: 40 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No goals yet</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              {g.status === 'active' && (
                <button
                  ...
                  style={{
                    ...
                    cursor: isRunning ? 'wait' : 'pointer', opacity: isRunning ? 0.6 : 1, fontFamily: DESIGN.fonts.body,
                  }}
                >
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer', color: '#6b6b70', fontFamily: DESIGN.fonts.body,
                }}
              >
      ...
      {showNewGoal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 18, fontWeight: 800, color: BLK, marginBottom: 18 }}>New Agent Goal</div>

            {/* Goal type */}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: DESIGN.fonts.body }}>Goal Type</label>
              <select value={newGoalType} onChange={e => setNewGoalType(e.target.value)} style={{
                ...
                fontSize: 13, fontFamily: DESIGN.fonts.body, background: '#fff',
              }}>
            ...
            {/* Scope — topics */}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: DESIGN.fonts.body }}>
              ...
              <input
                ...
                style={{
                  width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid #ececef',
                  fontSize: 13, fontFamily: DESIGN.fonts.body,
                }}
              />
            </div>
            ...
            <div style={{ display: 'flex', gap: 12, marginBottom: 14 }}>
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: DESIGN.fonts.body }}>Max Actions</label>
                <input type="number" value={newBudgetActions} onChange={e => setNewBudgetActions(parseInt(e.target.value) || 5)} style={{
                  width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid #ececef', fontSize: 13, fontFamily: DESIGN.fonts.body,
                }} />
              </div>
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: DESIGN.fonts.body }}>Budget ($)</label>
            ...
            <div style={{ marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <label htmlFor="req-approval" style={{ fontSize: 13, color: '#1f1f22', fontFamily: DESIGN.fonts.body }}>Require approval before destructive actions</label>
            </div>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              <button onClick={() => setShowNewGoal(false)} style={{
                ...
                fontSize: 13, fontWeight: 600, cursor: 'pointer', color: '#6b6b70', fontFamily: DESIGN.fonts.body,
              }}>Cancel</button>
              <button onClick={createGoal} disabled={creating} style={{
                ...
                opacity: creating ? 0.6 : 1, fontFamily: DESIGN.fonts.body,
              }}>
