  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 60 }}>
        ...
        <span style={{ marginLeft: 10, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, color: '#6b6b70' }}>Loading goals…</span>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 20, fontWeight: 800, color: BLK }}>Agent Goals</div>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={loadGoals} style={{
            ...
            cursor: 'pointer', color: BLK, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
          }}>
          ...
          <button onClick={() => setShowNewGoal(true)} style={{
            ...
            cursor: 'pointer', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
          }}>
      ...
      {goals.length === 0 && (
        <div style={{ ...card, textAlign: 'center', padding: 40 }}>
          ...
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No goals yet</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              {g.status === 'active' && (
                <button
                  ...
                  style={{
                    ...
                    cursor: isRunning ? 'wait' : 'pointer', opacity: isRunning ? 0.6 : 1, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                  }}
                >
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer', color: '#6b6b70', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                }}
              >
      ...
      {showNewGoal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 18, fontWeight: 800, color: BLK, marginBottom: 18 }}>New Agent Goal</div>

            {/* Goal type */}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>Goal Type</label>
              <select value={newGoalType} onChange={e => setNewGoalType(e.target.value)} style={{
                ...
                fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", background: '#fff',
              }}>
            ...
            {/* Scope — topics */}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>
              ...
              <input
                ...
                style={{
                  width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid #ececef',
                  fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                }}
              />
            </div>
            ...
            <div style={{ display: 'flex', gap: 12, marginBottom: 14 }}>
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>Max Actions</label>
                <input type="number" value={newBudgetActions} onChange={e => setNewBudgetActions(parseInt(e.target.value) || 5)} style={{
                  width: '100%', padding: '8px 12px', borderRadius: 8, border: '1px solid #ececef', fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                }} />
              </div>
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', display: 'block', marginBottom: 4, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>Budget ($)</label>
            ...
            <div style={{ marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <label htmlFor="req-approval" style={{ fontSize: 13, color: '#1f1f22', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>Require approval before destructive actions</label>
            </div>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              <button onClick={() => setShowNewGoal(false)} style={{
                ...
                fontSize: 13, fontWeight: 600, cursor: 'pointer', color: '#6b6b70', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
              }}>Cancel</button>
              <button onClick={createGoal} disabled={creating} style={{
                ...
                opacity: creating ? 0.6 : 1, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
              }}>
