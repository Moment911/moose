  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>Content Decay Prediction</div>
      ...
      <div style={card}>
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>Content Inventory</div>
        {loading ? (
      ...
      {selected && selected.decay_factors?.length > 0 && (
        <div style={card}>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 10 }}>Decay Factors — {selected.url}</div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
