    ...
    <div>
      ...
      <div style={card}>
        ...
        <textarea value={jobDesc} onChange={e => setJobDesc(e.target.value)} placeholder="Paste the Upwork job description..." rows={8} style={{
          width: '100%', padding: '12px 14px', border: '1px solid #ececef', borderRadius: 8, fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
        ...
        <>
          ...
          {a.hidden_requirements?.length > 0 && (
            <div style={{ ...card, borderLeft: `4px solid ${AMB}` }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: AMB, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {data.cover_letter && (
            <div style={card}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                ...
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, flex: 1 }}>Cover Letter Draft</div>
          ...
          <div style={{ ...card, textAlign: 'center' }}>
            <button onClick={generatePkg} disabled={generatingPkg} style={{
              ...
              border: 'none', background: BLK, color: '#fff', fontSize: 14, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
          ...
          {pkg && (
            <>
              {pkg.scope_document && (
                <div style={card}>
                  <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>Scope Document — {pkg.scope_document.project_title}</div>
              ...
              {pkg.faq?.length > 0 && (
                <div style={card}>
                  <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>FAQ</div>
                  {pkg.faq.map((f, i) => (
              ...
              {pkg.followup_email && (
                <div style={card}>
                  <div style={{ display: 'flex', alignItems: 'center', marginBottom: 12 }}>
                    <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, flex: 1 }}>Follow-up Email (72hr)</div>
...
const inp = { padding: '8px 12px', border: '1px solid #ececef', borderRadius: 8, fontSize: 12, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", boxSizing: 'border-box' }
const btnStyle = {
...
function Stat({ label, value, color }) {
  return (
    <div style={{ background: '#f9f9fb', borderRadius: 10, padding: '14px 18px', border: '1px solid #ececef' }}>
      ...
      <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 26, fontWeight: 900, color }}>{value}</div>
    </div>
  )
}
...
function FlagBlock({ title, color, Icon, items, objKey, sub }) {
  ...
  return (
    <div style={{ ...card, borderLeft: `4px solid ${color}` }}>
      <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color, marginBottom: 10, display: 'flex', alignItems: 'center', gap: 6 }}>
