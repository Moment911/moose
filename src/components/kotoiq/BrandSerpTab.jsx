  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 28 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>Brand SERP Score</div>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <button onClick={runScan} disabled={scanning} style={{
              ...
              fontFamily: DESIGN.fonts.body, cursor: scanning ? 'wait' : 'pointer', opacity: scanning ? 0.6 : 1,
            }}>
            ...
            {data && (
              <button onClick={loadStrategy} disabled={strategyLoading} style={{
                ...
                fontFamily: DESIGN.fonts.body, cursor: strategyLoading ? 'wait' : 'pointer',
              }}>
      ...
      {!data && !scanning && (
        <div style={{ ...card, textAlign: 'center', padding: 48 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No Brand SERP Data</div>
        ...
        <>
          ...
          <div style={card}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 10 }}>
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 36, fontWeight: 900, color: data.owned_results >= 5 ? GRN : data.owned_results >= 3 ? AMB : R }}>
                {data.owned_results}
              </div>
              <div>
          ...
          {data.negative_results?.length > 0 && (
            <div style={{ ...card, border: `1px solid #ececef`, background: R + '05' }}>
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: R, marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          {data.has_knowledge_panel && data.kp_description && (
            <div style={card}>
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
