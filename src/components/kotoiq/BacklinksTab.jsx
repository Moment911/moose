  ...
  return (
    <div style={{ position: 'relative', width: size, height: size }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: size * 0.32, fontWeight: 900, color, lineHeight: 1 }}>{score}</div>
...
function StatBox({ label, value, sub, color }) {
  return (
    <div style={{ background: '#f9f9fb', borderRadius: 10, padding: '14px 18px', flex: 1, minWidth: 120 }}>
      <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase', letterSpacing: '.05em', fontFamily: DESIGN.fonts.body, marginBottom: 4 }}>{label}</div>
      <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 24, fontWeight: 900, color: color || BLK, lineHeight: 1 }}>{value}</div>
  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 28 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>Backlink Profile Score</div>
          ...
          <button onClick={runAnalysis} disabled={analyzing} style={{
            ...
            fontFamily: DESIGN.fonts.body, cursor: analyzing ? 'wait' : 'pointer', opacity: analyzing ? 0.6 : 1,
          }}>
      ...
      {!data && !analyzing && (
        <div style={{ ...card, textAlign: 'center', padding: 48 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No Backlink Data</div>
        ...
        <>
          ...
          {data.toxic_links?.length > 0 && (
            <div style={{ ...card, border: `1px solid #ececef` }}>
              <button onClick={() => setShowToxic(!showToxic)} style={{
                fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: R, display: 'flex', alignItems: 'center', gap: 8,
          ...
          {data.high_quality_links?.length > 0 && (
            <div style={{ ...card, border: `1px solid ${GRN}30` }}>
              <button onClick={() => setShowHQ(!showHQ)} style={{
                fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: GRN, display: 'flex', alignItems: 'center', gap: 8,
          ...
          <div style={{ display: 'flex', gap: 10, marginBottom: 14 }}>
            <div style={{ ...card, flex: 1, marginBottom: 0 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase', letterSpacing: '.05em', fontFamily: DESIGN.fonts.body, marginBottom: 6 }}>.edu / .gov Links</div>
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 28, fontWeight: 900, color: data.edu_gov_links > 0 ? GRN : '#d1d5db' }}>{data.edu_gov_links}</div>
              <div style={{ fontSize: 11, color: '#1f2937' }}>{data.edu_gov_links > 0 ? 'Strong trust signals' : 'No .edu/.gov backlinks'}</div>
            </div>
            <div style={{ ...card, flex: 1, marginBottom: 0 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase', letterSpacing: '.05em', fontFamily: DESIGN.fonts.body, marginBottom: 6 }}>Trust Rank Estimate</div>
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 28, fontWeight: 900, color: data.trust_rank_estimate >= 40 ? GRN : data.trust_rank_estimate >= 20 ? AMB : R }}>
          ...
          {data.competitor_comparison?.length > 0 && (
            <div style={card}>
              <button onClick={() => setShowComp(!showComp)} style={{
                fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK, display: 'flex', alignItems: 'center', gap: 8,
