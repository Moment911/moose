  ...
  return (
    <div style={{ position: 'relative', width: size, height: size }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: size * 0.32, fontWeight: 900, color }}>{score}</div>
...
function StatCard({ label, value, icon: Icon, color, sub }) {
  return (
    <div style={{ background: '#f9f9fb', borderRadius: 12, padding: '14px 18px', border: '1px solid #ececef' }}>
      ...
      <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 28, fontWeight: 900, color }}>{value}</div>
  ...
  return (
    <div style={{ ...card, background: critical > 0 ? '#f9f9fb' : '#f9f9fb', border: `1px solid ${critical > 0 ? '#e9695c' : AMB}25` }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
        ...
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 800, color: BLK }}>
          ...
          return (
            <div key={rec.key} style={{ borderRadius: 10, border: `1px solid ${sev.border}`, overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: sev.bg }}>
                ...
                <div style={{ flex: 1, fontFamily: DESIGN.fonts.body, fontSize: 13, fontWeight: 800, color: BLK }}>
                  {rec.title} ({count})
                </div>
  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 28 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>GSC Deep Audit</div>
