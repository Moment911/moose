  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ ...cardStyle, marginBottom: 20 }}>
        <div style={{ fontSize: 16, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK, marginBottom: 14 }}>
          Data Sources
        </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 600, color: BLK,
                }}
              >
                {connected
      ...
      <div style={{ ...cardStyle, marginBottom: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          <div style={{ fontSize: 16, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK }}>
            Target Keywords
          </div>
            ...
            {keywords.map(kw => (
              <div
                ...
                style={{
                  ...
                  background: '#f1f1f6', fontSize: 12, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK,
                }}
              >
                {kw}
                <Trash2
      ...
      <div style={{ ...cardStyle, marginBottom: 20 }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontSize: 12, fontWeight: 600, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 600, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK }}>
            Auto-publish pages
          </span>
          <span style={{ fontSize: 11, color: '#6b6b70', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>
      ...
      {run && (
        <div style={{ ...cardStyle, marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: STATUS_COLORS[run.status] || BLK }}>
              ...
              return (
                <div key={stage.stage} style={{ display: 'flex', alignItems: 'center', flex: isLast ? '0 0 auto' : 1 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                    ...
                    <span style={{ fontSize: 10, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color, textAlign: 'center', whiteSpace: 'nowrap' }}>
                      {stage.stage_name}
                    </span>
                  </div>
                  {!isLast && (
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    <span style={{ fontSize: 11, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#6b6b70' }}>
                      {stage.steps_complete}/{stage.steps_total} steps
                    </span>
                    {stage.duration_ms != null && (
                      <span style={{ fontSize: 11, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#8e8e93' }}>
                    ...
                    {stage.steps.map((step, i) => (
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                          ...
                          <span style={{ fontSize: 12, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK }}>{step.step}</span>
                        </div>
                        {step.error && (
                          <span style={{ fontSize: 11, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#ef4444', maxWidth: 300, textAlign: 'right' }}>
                            {step.error}
                          </span>
                        )}
                      </div>
        ...
        <div style={{ ...cardStyle }}>
          ...
          <div style={{ display: 'flex', gap: 16, marginBottom: 16, flexWrap: 'wrap' }}>
            {[
              ...
              >
                <div style={{ fontSize: 28, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: stat.color }}>
                  {stat.value}
                </div>
                <div style={{ fontSize: 11, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#6b6b70', textTransform: 'uppercase', letterSpacing: '.04em' }}>
                  {stat.label}
                </div>
              </div>
            ))}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {run.results.published_urls.map((url, i) => (
                  <a
                    ...
                    style={{
                      display: 'flex', alignItems: 'center', gap: 6,
                      fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#3b82f6',
                      textDecoration: 'none',
                    }}
                  >
            ...
            <div style={{ marginTop: 14 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {run.results.errors.map((err, i) => (
                  <div key={i} style={{ fontSize: 12, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#ef4444' }}>
                    {err}
                  </div>
                ))}
              </div>
