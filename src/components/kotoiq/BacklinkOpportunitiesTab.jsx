  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>Link Building Opportunities</div>
        ...
        return (
          <div key={type} style={{ ...card, borderLeft: `4px solid ${meta.color}` }}>
            <button onClick={() => setTypeOpen(s => ({ ...s, [type]: !open }))} style={{
              ...
              display: 'flex', alignItems: 'center', gap: 8, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: open ? 12 : 0,
            }}>
      ...
      {opps.length === 0 && !running && (
        <div style={{ ...card, textAlign: 'center', padding: 40 }}>
          ...
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 700, color: BLK, marginBottom: 6 }}>No Opportunities Yet</div>
