  ...
  return (
    <svg width={size} height={size} style={{ transform: 'rotate(-90deg)' }}>
      ...
      <text x={size / 2} y={size / 2} textAnchor="middle" dominantBaseline="central"
        style={{ transform: 'rotate(90deg)', transformOrigin: 'center', fontFamily: DESIGN.fonts.body, fontSize: size * 0.32, fontWeight: 900, fill: color }}>
        {score}
      </text>
    </svg>
  )
  ...
  return (
    <div style={{ textAlign: 'center', padding: '8px 16px', background: '#fff', borderRadius: 10, border: '1px solid #ececef' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4, marginBottom: 4 }}>
        ...
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 900, color, lineHeight: 1 }}>{score || '--'}</div>
      </div>
...
function PriorityBadge({ priority }) {
  ...
  return (
    <span style={{ fontFamily: DESIGN.fonts.body, fontSize: 12, fontWeight: 800, color, background: color + '12', padding: '1px 6px', borderRadius: 8 }}>
      P{priority}
    </span>
  )
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8, marginBottom: 8 }}>
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 14, fontWeight: 800, color: BLK, lineHeight: 1.3, marginBottom: 4 }}>
            {node.entity}
          </div>
        ...
        {node.search_volume > 0 && (
          <div style={{ textAlign: 'right', flexShrink: 0 }}>
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 14, fontWeight: 900, color: BLK }}>{fmtN(node.search_volume)}</div>
  ...
  if (!map) {
    return (
      <div style={{ ...card, textAlign: 'center', padding: '48px 32px' }}>
        ...
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 900, color: BLK, marginBottom: 8 }}>No Topical Map Yet</div>
        ...
        <button onClick={generateMap} disabled={generating}
          style={{
            ...
            fontSize: 14, fontWeight: 700, fontFamily: DESIGN.fonts.body, cursor: generating ? 'wait' : 'pointer',
  ...
  return (
    <div>
      ...
      <div style={{ ...card, background: '#f9f9fb', border: `1px solid ${T}25`, display: 'flex', gap: 14, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 4 }}>What is a Topical Map?</div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 22, fontWeight: 900, color: BLK, letterSpacing: '-.02em', marginBottom: 4 }}>
            Topical Map
          </div>
      ...
      <div style={{ ...card, padding: '14px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: BLK, fontFamily: DESIGN.fonts.body }}>Coverage Distribution</div>
          <div style={{ flex: 1 }} />
      ...
      <div style={{ ...card }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 14, fontWeight: 800, color: BLK, textTransform: 'uppercase', letterSpacing: '.04em' }}>
            KotoIQ Identity
          </div>
          <button onClick={() => {
            if (editingIdentity) {
        ...
        {!editingIdentity ? (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
            <div>
              ...
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 800, color: BLK }}>{map.central_entity || '--'}</div>
            </div>
            <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
            <div>
              ...
              <input value={identityForm.central_entity} onChange={e => setIdentityForm(p => ({ ...p, central_entity: e.target.value }))}
                style={{ width: '100%', padding: '8px 10px', borderRadius: 6, border: '1px solid #ececef', fontSize: 13, fontFamily: DESIGN.fonts.body, fontWeight: 700 }} />
            </div>
            <div>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1f2937', textTransform: 'uppercase', letterSpacing: '.05em', marginBottom: 4 }}>Source Context</div>
      ...
      {(filter === 'all' || filter === 'core' || filter === 'gaps' || filter === 'covered') && coreFiltered.length > 0 && (
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
            ...
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK }}>
              Core Section
            </div>
