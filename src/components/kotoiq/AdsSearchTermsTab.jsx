  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK }}>Search Terms Explorer</div>
        <div style={{ display: 'flex', gap: 8 }}>
          <div style={{ position: 'relative' }}>
            ...
            <input value={filter} onChange={e => setFilter(e.target.value)} placeholder="Filter terms..."
              style={{ paddingLeft: 30, padding: '8px 12px 8px 30px', border: '1px solid #ececef', borderRadius: 8, fontSize: 13, fontFamily: DESIGN.fonts.body, width: 200 }} />
          </div>
