  ...
  return (
    <div style={{ position: 'relative', width: size, height: size }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: size * 0.3, fontWeight: 900, color }}>{score}</div>
      </div>
    </div>
  )
}
        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
            <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 18, marginBottom: 0 }}>
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 800, color: BLK }}>Originality</div>
            ...
            <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 18, marginBottom: 0 }}>
              ...
              <div>
                <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 800, color: BLK }}>AI Likelihood</div>
          ...
          {data.originality_score >= 80 && !data.plagiarized_chunks?.length && (
            <div style={{ ...card, borderLeft: `4px solid ${GRN}` }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: GRN }}>Content looks original</div>
