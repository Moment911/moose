...
function IssueCard({ title, icon, color, items, renderItem, emptyMsg }) {
    ...
    return (
      <div style={{ maxWidth: 520, margin: '60px auto', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 13, color: '#6b7280', lineHeight: 1.6, marginBottom: 24 }}>
          Crawl your site to discover orphan pages, equity-starved content, duplicate anchors, and linking opportunities.
        </p>
    ...
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <IssueCard
          ...
          renderItem={(url) => (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{shortUrl(url)}</span>
        ...
        <IssueCard
          ...
          renderItem={(item) => (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{shortUrl(item.url)}</span>
      ...
      <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #e5e7eb', padding: '18px 22px', marginBottom: 20 }}>
        ...
        {breadcrumbIssues.length > 0 && (
          <div>
            <div style={{ fontSize: 11, fontWeight: 600, color: '#6b7280', marginBottom: 6 }}>Pages missing breadcrumbs ({breadcrumbIssues.length}):</div>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: `2px solid ${T}`, padding: '18px 22px', marginBottom: 20 }}>
          ...
          {suggestLoading ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {suggestions.summary && (
                <div style={{ fontSize: 12, color: '#6b7280', lineHeight: 1.6, padding: '8px 12px', background: '#f9fafb', borderRadius: 8 }}>
                  {suggestions.summary}
                </div>
              )}
