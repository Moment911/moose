    ...
    <div>
      ...
      {data && (
        <>
          ...
          <div style={card}>
            <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>Heatmap</div>
            {grid.length > 0 && (
              <div style={{
                ...
                {grid.flat().map((cell, i) => (
                  <div key={i} style={{
                    ...
                    color: '#fff', fontSize: 12, fontWeight: 900, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                  }}>
                    {cell?.position || '—'}
                  </div>
                ))}
          ...
          {data.dead_zones?.length > 0 && (
            <div style={{ ...card, borderLeft: `4px solid ${R}` }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: R, marginBottom: 12 }}>Dead Zones</div>
