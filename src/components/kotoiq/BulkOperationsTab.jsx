  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK }}>Agency-wide operations</div>
            ...
            return (
              <button key={op.key} onClick={() => setOperation(op.key)} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                  ...
                  <div style={{ fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, color: BLK }}>{op.label}</div>
                </div>
      ...
      <button onClick={startBulk} disabled={starting || selectedIds.length === 0 || !agencyId}
        style={{
          ...
          color: '#fff', fontSize: 15, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
      ...
      {status && (
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #ececef', padding: '20px 24px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ fontSize: 15, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK, display: 'flex', alignItems: 'center', gap: 8 }}>
...
const sectionLabel = {
  fontSize: 12, fontWeight: 800, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: '#334155',
