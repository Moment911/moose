  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK }}>Anomaly Detection</div>
      ...
      {loading ? <div style={{ ...card, textAlign: 'center', padding: 40 }}><Loader2 size={24} color="#0a0a0a" style={{ animation: 'spin 1s linear infinite' }} /></div> : (
        <>
          {alerts.length === 0 && <div style={{ ...card, textAlign: 'center', padding: 40, color: '#8e8e93' }}>
            ...
            <div style={{ fontFamily: DESIGN.fonts.body, fontWeight: 700 }}>No anomalies detected</div>
              ...
              <div key={i} style={{ ...card, borderLeft: `4px solid ${sev.color}` }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }} onClick={() => setExpanded(isExpanded ? null : i)}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontFamily: DESIGN.fonts.body, fontWeight: 700, fontSize: 14 }}>{a.metric} anomaly</span>
                ...
                {isExpanded && (
                  <div style={{ marginTop: 12, paddingTop: 12, borderTop: '1px solid #ececef' }}>
                    <div style={{ fontSize: 13, color: '#1f1f22', lineHeight: 1.6, marginBottom: 12, fontFamily: DESIGN.fonts.body }}>{a.explanation_md}</div>
