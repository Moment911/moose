  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <svg width={size} height={size} viewBox="0 0 80 80">
        ...
        <text x="40" y="44" textAnchor="middle" style={{ fontSize: 18, fontWeight: 900, fontFamily: DESIGN.fonts.body, fill: BLK }}>{score || '--'}</text>
      </svg>
  ...
  return (
    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
      {items.map((item, i) => {
        ...
        return (
          <span key={i} style={{
            fontSize: size, fontWeight: 600 + Math.round(ratio * 200), fontFamily: DESIGN.fonts.body,
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 900, color: BLK }}>KotoAgenticIQ Content Network</div>
        ...
        <button onClick={runAnalysis} disabled={running}
          style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 20px', borderRadius: 10, border: 'none', background: "#0a0a0a", color: '#fff', fontSize: 14, fontWeight: 700, fontFamily: DESIGN.fonts.body, cursor: running ? 'wait' : 'pointer', opacity: running ? 0.6 : 1 }}>
      ...
      {loading && (
        <div style={{ textAlign: 'center', padding: 60, color: '#1f2937' }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontWeight: 600 }}>Loading analysis...</div>
        </div>
      )}
      ...
      {!loading && !analysis && (
        <div style={{ ...card, textAlign: 'center', padding: 60 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No KotoIQ Analysis Yet</div>
        ...
        <>
          ...
          <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 32 }}>
            ...
            <div style={{ flex: 1, borderLeft: '1px solid #ececef', paddingLeft: 24, marginLeft: 8 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#1f1f22', marginBottom: 4, fontFamily: DESIGN.fonts.body }}>QUICK SUMMARY</div>
          ...
          <div style={card}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20 }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 36, fontWeight: 900, color: a.contextual_flow_score >= 70 ? GRN : a.contextual_flow_score >= 40 ? AMB : R }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 36, fontWeight: 900, color: a.contextual_consistency_score >= 70 ? GRN : a.contextual_consistency_score >= 40 ? AMB : R }}>
