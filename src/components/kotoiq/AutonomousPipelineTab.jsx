...
function ScoreBadge({ score, label }) {
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #ececef', borderRadius: 10, padding: '10px 14px', textAlign: 'center', minWidth: 96 }}>
      <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 22, fontWeight: 900, color }}>{s || '—'}</div>
    ...
    <div>
      ...
      <div style={{ ...card, background: `linear-gradient(135deg, #f9f9fb 0%, #f9f9fb 100%)`, borderColor: T + '40' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
          ...
          <div>
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 22, fontWeight: 900, color: BLK }}>Auto-Pilot Content Generation</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <input
            ...
            style={{
              ...
              fontSize: 15, fontFamily: DESIGN.fonts.body, color: BLK, outline: 'none',
            }}
          />
          <button
            ...
            style={{
              ...
              fontSize: 14, fontWeight: 800, fontFamily: DESIGN.fonts.body,
      ...
      {(running || result) && (
        <div style={card}>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 14 }}>Pipeline Progress</div>
      ...
      {result && (
        <>
          <div style={card}>
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 14 }}>Scores</div>
          ...
          {result.schema_json_ld?.length > 0 && (
            <div style={card}>
              <button onClick={() => setSchemaOpen(!schemaOpen)} style={{
                ...
                padding: 0, cursor: 'pointer', fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK,
              }}>
