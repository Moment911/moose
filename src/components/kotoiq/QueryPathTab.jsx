  ...
  if (!data) return (
    <div style={card}>
      <div style={{ textAlign: 'center', padding: '40px 20px' }}>
        ...
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 18, fontWeight: 800, color: BLK, marginBottom: 8 }}>Query Path Analyzer</div>
  ...
  return (
    <>
      ...
      <div style={{ ...card, background: '#f9f9fb', border: `1px solid #ececef` }}>
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 6, display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          return (
            <div key={i} style={{ ...card, marginBottom: 0 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 10 }}>
                <div>
                  <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 4 }}>
              ...
              {expanded && (
                <div style={{ marginTop: 14, borderTop: '1px solid #f1f1f6', paddingTop: 12 }}>
                  ...
                  <div style={{ fontSize: 11, color: '#1f2937', marginBottom: 8 }}>
                    Avg session depth: <span style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontWeight: 700, color: BLK }}>{cluster.avg_session_depth || '—'}</span> queries
                  </div>
      ...
      {(data.all_gaps || []).length > 0 && (
        <div style={{ ...card, marginTop: 14 }}>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 12, display: 'flex', alignItems: 'center', gap: 6 }}>
