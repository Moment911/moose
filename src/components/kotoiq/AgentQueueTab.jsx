  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 60 }}>
        ...
        <span style={{ marginLeft: 10, fontFamily: DESIGN.fonts.body, fontSize: 14, color: '#6b6b70' }}>Loading approvals…</span>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 20, fontWeight: 800, color: BLK }}>Agent Queue</div>
      ...
      {actions.length === 0 && (
        <div style={{ ...card, textAlign: 'center', padding: 40 }}>
          ...
          <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No pending approvals</div>
        ...
        return (
          <div key={a.id} style={card}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 15, fontWeight: 800, color: BLK }}>{a.tool_name}</div>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600, cursor: 'pointer', fontFamily: DESIGN.fonts.body,
                }}
              >
      ...
      {rejectModal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: DESIGN.fonts.body, fontSize: 16, fontWeight: 800, color: BLK, marginBottom: 12 }}>Reject Action</div>
            ...
            <textarea
              ...
              style={{
                ...
                fontSize: 13, fontFamily: DESIGN.fonts.body, resize: 'vertical', marginBottom: 14,
              }}
            />
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              ...
              <button onClick={handleReject} style={{
                ...
                fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: DESIGN.fonts.body,
              }}>Reject</button>
            </div>
          </div>
        </div>
