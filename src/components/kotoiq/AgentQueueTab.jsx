  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 60 }}>
        ...
        <span style={{ marginLeft: 10, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, color: '#6b6b70' }}>Loading approvals…</span>
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 20, fontWeight: 800, color: BLK }}>Agent Queue</div>
      ...
      {actions.length === 0 && (
        <div style={{ ...card, textAlign: 'center', padding: 40 }}>
          ...
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 700, color: BLK, marginBottom: 6 }}>No pending approvals</div>
        ...
        return (
          <div key={a.id} style={card}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK }}>{a.tool_name}</div>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600, cursor: 'pointer', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
                }}
              >
      ...
      {rejectModal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 16, fontWeight: 800, color: BLK, marginBottom: 12 }}>Reject Action</div>
            ...
            <textarea
              ...
              style={{
                ...
                fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", resize: 'vertical', marginBottom: 14,
              }}
            />
