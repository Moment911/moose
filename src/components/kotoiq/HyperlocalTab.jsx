  ...
  return (
    <div>
      ...
      <div style={{ ...card, display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 20, fontWeight: 800, color: BLK, marginBottom: 4 }}>Hyperlocal Content Generator</div>
      ...
      <div style={{ ...card, background: '#f9f9fb', borderColor: T + '30' }}>
        <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 8 }}>How it works</div>
        <ol style={{ margin: 0, paddingLeft: 22, fontSize: 13, lineHeight: 1.7, color: '#1f1f22', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>
      ...
      {!loadingScans && !hasScans ? (
        <div style={{ ...card, borderLeft: `4px solid ${AMB}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK, marginBottom: 4 }}>No Grid Scans Found</div>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 13, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", cursor: 'pointer',
        ...
        <div style={card}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
            <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK }}>Source Grid Scan</div>
            <select
              ...
              style={{
                ...
                fontSize: 13, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", color: BLK, background: '#fff', outline: 'none',
              }}>
            ...
            <button
              ...
              style={{
                ...
                fontSize: 13, fontWeight: 700, fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif",
          ...
          {genError && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 0 0' }}>
              ...
              <div style={{ fontSize: 13, color: '#dc2626', fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>{genError}</div>
            </div>
          )}
        </div>
      )}
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12, marginBottom: 14 }}>
            <div style={{ ...card, margin: 0, textAlign: 'center' }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 32, fontWeight: 900, color: R, letterSpacing: '-.02em' }}>{result.dead_zones_analyzed || 0}</div>
            ...
            <div style={{ ...card, margin: 0, textAlign: 'center' }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 32, fontWeight: 900, color: T, letterSpacing: '-.02em' }}>{result.neighborhoods_identified?.length || 0}</div>
            ...
            <div style={{ ...card, margin: 0, textAlign: 'center' }}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 32, fontWeight: 900, color: GRN, letterSpacing: '-.02em' }}>{result.briefs_created?.length || 0}</div>
            ...
            <div style={{ ...card, background: GRN + '08', borderColor: GRN + '40' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 18, fontWeight: 800, color: GRN, marginTop: 2 }}>{result.estimated_coverage_improvement}</div>
                </div>
              </div>
            </div>
          )}
          ...
          {result.neighborhoods_identified?.length > 0 && (
            <div style={card}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>Neighborhoods Identified</div>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: 10 }}>
                {result.neighborhoods_identified.map((n, i) => (
                  <div key={i} style={{ padding: '12px 14px', background: '#f9f9fb', borderRadius: 10, border: '1px solid #ececef' }}>
                    <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 14, fontWeight: 800, color: BLK }}>{n.name}</div>
          ...
          {result.briefs_created?.length > 0 && (
            <div style={card}>
              <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 15, fontWeight: 800, color: BLK, marginBottom: 12 }}>Briefs Created</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {result.briefs_created.map((b, i) => (
                  <div key={b.brief_id || i} style={{
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, system-ui, sans-serif", fontSize: 13, fontWeight: 800, color: BLK }}>{b.neighborhood}</div>
