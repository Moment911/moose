      ...
      <div className="card w-full max-w-md shadow-2xl">
        ...
        <div className="p-6 space-y-3">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-xl space-y-3">
            ...
            <div>
              <label className="text-[10px] text-gray-400 mb-1 block">Brand Name (replaces "Momenta Marketing")</label>
            ...
            <p className="text-[10px] text-gray-400">Client portal will show your brand instead of Momenta Marketing</p>
          </div>
