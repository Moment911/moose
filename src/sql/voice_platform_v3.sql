-- ══════════════════════════════════════════════════════════════════════════════
-- VOICE PLATFORM V3 — DNC, Timezone, Transfers, IVR, Callers, Intelligence
-- Run in Supabase SQL Editor
-- ══════════════════════════════════════════════════════════════════════════════

-- Repeat caller profiles (inbound)
...
-- Voice leads: DNC, timezone, transfer, research, intelligence
...
-- Voice calls: coaching, intelligence, transfer
...
-- Voice agents: personality, transfer, local presence, AMD
...
-- Inbound agents: IVR, auto-callback
...
-- Inbound calls: callback tracking, transfer
