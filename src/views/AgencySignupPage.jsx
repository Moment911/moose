...
import {
  ArrowRight, BarChart2, Check, Eye, EyeOff, Globe, HardDrive, Loader2, Shield, Star, Users, Zap
} from 'lucide-react'
            ...
            <div style={{ background: '#fff', borderRadius: 20, border: '1px solid #e5e7eb', padding: '36px' }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display:'flex', gap:8 }}>
                  <input
                    ...
                    placeholder="KOTO20"
                    style={{ flex:1, padding:'10px 14px', borderRadius:10, border:`1.5px solid ${coupon?'#16a34a':couponError?'#cb1c6b':'#e5e7eb'}`, fontSize:14, outline:'none', fontFamily:'inherit', textTransform:'uppercase', letterSpacing:'.1em' }}
                  />
                ...
                {couponError && (
                  <div style={{ marginTop:6, fontSize:13, color:'#cb1c6b', fontWeight:600 }}>{couponError}</div>
                )}
              </div>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <p style={{ fontSize:12, color:'#9ca3af', textAlign:'center', margin:'0 0 8px', lineHeight:1.6 }}>
                  ...
                  <a href="/terms" target="_blank" style={{ color:'#cb1c6b', fontWeight:700 }}>Terms of Service</a>{' '}
                  and{' '}
                  <a href="/privacy" target="_blank" style={{ color:'#cb1c6b', fontWeight:700 }}>Privacy Policy</a>.
