...
const BRANDING_DEFAULTS={
  agency_name:'', agency_logo:'', primary_color:'#ea2729',
        ...
        <div style={{background:BLK,padding:'20px 32px 0',flexShrink:0}}>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',paddingBottom:14}}>
            <div>
              ...
              <p style={{fontSize:13,color:'rgba(255,255,255,.4)',margin:'3px 0 0',fontFamily:FB}}>Build branded PDF-ready reports for your clients</p>
            </div>
