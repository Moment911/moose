        ...
        <div style={{background:BLK,padding:'20px 32px 0',flexShrink:0}}>
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',paddingBottom:14}}>
            <div>
              ...
              <p style={{fontSize:13,color:'rgba(255,255,255,.4)',margin:'3px 0 0',fontFamily:FB}}>AI content strategy from your real GSC data</p>
            </div>
              ...
              {s.content_health&&(
                <div style={{background:`linear-gradient(135deg, ${BLK} 0%, #1a1a2e 100%)`,borderRadius:16,padding:'18px 22px',marginBottom:16,display:'flex',gap:12,alignItems:'flex-start'}}>
                  ...
                  <div>
                    ...
                    <div style={{fontSize:14,color:'rgba(255,255,255,.85)',fontFamily:FB,lineHeight:1.7}}>{s.content_health}</div>
                  </div>
                </div>
              )}
              {tab==='clusters'&&(
