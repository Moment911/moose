...
const TEMPLATES = [
  {
    ...
    blocks: [
      ...
      { type: 'hero', data: { heading: 'Welcome to Koto!', subtext: "We're thrilled to have you as a client.", btnText: 'View Your Project', btnUrl: '#', bgColor: '#ea2729', textColor: '#ffffff', btnColor: '#ffffff' } },
