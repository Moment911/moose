...
const TEMPLATES = [
  {
    ...
    preview: { header: '#231f20', hero: '#E6007E', body: true, cta: true, footer: true },
    blocks: [
      { type: 'header', data: { logoText: 'Koto', tagline: 'Welcome aboard!', bgColor: '#231f20', textColor: '#ffffff' } },
      { type: 'hero', data: { heading: 'Welcome to Koto!', subtext: "We're thrilled to have you as a client.", btnText: 'View Your Project', btnUrl: '#', bgColor: '#E6007E', textColor: '#ffffff', btnColor: '#ffffff' } },
      ...
      { type: 'button', data: { text: 'View Your Dashboard', url: '#', btnColor: '#E6007E', textColor: '#fff', bgColor: '#fff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'button', data: { text: 'Review Designs Now', url: '#', btnColor: '#E6007E', textColor: '#fff', bgColor: '#fff', align: 'center', padding: 32, borderRadius: 8 } },
      { type: 'footer', data: { text: '\u00a9 2026 Koto', links: 'Unsubscribe', bgColor: '#f5f5f5', textColor: '#999', padding: 24 } },
    ]
  },
  {
    ...
    blocks: [
      ...
      { type: 'hero', data: { heading: "What We've Been Working On", subtext: 'A look at our latest projects and tips', btnText: 'Read More', btnUrl: '#', bgColor: '#1a1a2e', textColor: '#fff', btnColor: '#E6007E' } },
      ...
      { type: 'button', data: { text: 'Visit Our Portfolio', url: '#', btnColor: '#E6007E', textColor: '#fff', bgColor: '#fff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'button', data: { text: 'Leave Feedback', url: '#', btnColor: '#E6007E', textColor: '#fff', bgColor: '#fff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'button', data: { text: 'Download Files', url: '#', btnColor: '#E6007E', textColor: '#fff', bgColor: '#fff', align: 'center', padding: 24, borderRadius: 8 } },
      { type: 'footer', data: { text: '\u00a9 2026 Koto', links: 'Unsubscribe', bgColor: '#f5f5f5', textColor: '#999', padding: 24 } },
    ]
  },
  {
              ...
              <div key={i} className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all group" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
                ...
                <div className="h-48 bg-gray-50 p-4 border-b border-gray-100 overflow-hidden">
                  <div className="mx-auto bg-white rounded-lg shadow-sm overflow-hidden" style={{ width: '100%', maxWidth: 240 }}>
                    ...
                    {tpl.preview.quote && <div style={{ padding: '6px 12px', borderLeft: '3px solid #E6007E', margin: '4px 12px', background: '#f9fafb' }}><div className="h-1 bg-gray-200 rounded-full w-full" /></div>}
                    ...
                    {tpl.preview.cta && <div style={{ padding: '6px 12px', textAlign: 'center' }}><span style={{ display: 'inline-block', background: '#E6007E', color: '#fff', fontSize:13, padding: '3px 12px', borderRadius: 4 }}>Button</span></div>}
                  ...
                  {preview.blocks.map((b, i) => {
                    ...
                    return (
                      <div key={i}>
                        ...
                        {b.type === 'quote' && <div style={{ background: d.bgColor, padding: `${d.padding}px 32px` }}><div style={{ borderLeft: '4px solid #E6007E', paddingLeft: 16 }}><p style={{ margin: 0, fontStyle: 'italic', color: d.textColor, fontSize: 16 }}>{d.text}</p>{d.author && <p style={{ margin: '8px 0 0', color: d.textColor, opacity: 0.6, fontSize: 15 }}>&mdash; {d.author}</p>}</div></div>}
