...
const BLOCK_TYPES = [
  ...
  { type: 'button', label: 'Button', icon: MousePointer, defaults: { text: 'Learn More', url: '#', btnColor: '#cb1c6b', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 24, borderRadius: 8 } },
          ...
          {sel ? (
            ...
            <div style={{ width: panelWidth }} className="bg-white border-l border-gray-200 p-4 flex-shrink-0">
              ...
              <div className="mt-4 space-y-2">
                <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-brand-500" /><span className="text-[13px] text-gray-700">Koto Red: #cb1c6b</span></div>
