...
export default function ProjectPage() {
  ...
  function handleExportPdf(round) {
    ...
    <div style="margin-top:40px;padding-top:16px;border-top:1px solid #eee;color:#999;font-size:11px">Generated by Moose Design Review Platform</div>
    </body></html>`
