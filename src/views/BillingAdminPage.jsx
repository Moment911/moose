...
export default function BillingAdminPage() {
  ...
  async function loadData() {
    setLoading(true)
    try {
      const [mrrRes, agRes, prRes] = await Promise.all([
  ...
  const TABS = ['Revenue', 'Agencies', 'Platform Pricing']
        ...
        <div style={{ background: BLK, padding: '20px 32px 0', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
            <div>
              ...
              <p style={{ fontSize: 13, color: 'rgba(255,255,255,.4)', margin: '4px 0 0' }}>Platform revenue, agency billing, pricing</p>
            </div>
