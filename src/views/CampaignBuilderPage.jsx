...
const BLOCK_TYPES = [
  ...
  { type: 'heading', label: 'Heading', icon: Type, cat: 'Content', defaults: { content: 'Your Headline Here', fontSize: 32, textColor: '#201b51', bgColor: '#ffffff', align: 'center', padding: 32, fontWeight: 700 } },
  { type: 'image', label: 'Image', icon: ImageIcon, cat: 'Content', defaults: { src: '', alt: '', bgColor: '#ffffff', padding: 16 } },
  { type: 'button', label: 'Button', icon: MousePointer, cat: 'Content', defaults: { text: 'Click Here', url: '#', btnColor: '#cb1c6b', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  { type: 'hero', label: 'Hero', icon: Star, cat: 'Layout', defaults: { heading: 'Big Bold Headline', subtext: 'Supporting text that explains the value proposition', btnText: 'Get Started', btnUrl: '#', bgColor: '#231f20', textColor: '#ffffff', btnColor: '#cb1c6b' } },
...
const TEMPLATES = [
  { name: 'Welcome Email', desc: 'Warm welcome for new clients', blocks: [
    ...
    { type: 'hero', data: { heading: 'Welcome to Koto!', subtext: "We're thrilled to have you as a client. Here's what happens next.", btnText: 'View Your Project', btnUrl: '#', bgColor: '#cb1c6b', textColor: '#ffffff', btnColor: '#ffffff' } },
    ...
    { type: 'button', data: { text: 'View Your Dashboard', url: '#', btnColor: '#cb1c6b', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  { name: 'Design Ready', desc: 'Notify client designs are ready', blocks: [
    ...
    { type: 'heading', data: { content: 'Your Designs Are Ready! \ud83c\udfa8', fontSize: 28, textColor: '#201b51', bgColor: '#ffffff', align: 'center', padding: 32, fontWeight: 700 } },
    ...
    { type: 'button', data: { text: 'Review Designs Now', url: '#', btnColor: '#cb1c6b', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 32, borderRadius: 8 } },
  ...
  { name: 'Monthly Newsletter', desc: 'Multi-section newsletter', blocks: [
    ...
    { type: 'hero', data: { heading: 'What We\'ve Been Working On', subtext: 'A look at our latest projects, tips, and updates', btnText: 'Read More', btnUrl: '#', bgColor: '#1a1a2e', textColor: '#ffffff', btnColor: '#cb1c6b' } },
