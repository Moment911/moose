...
const BLOCK_TYPES = [
  ...
  { type: 'button', label: 'Button', icon: MousePointer, cat: 'Content', defaults: { text: 'Click Here', url: '#', btnColor: '#E6007E', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  { type: 'hero', label: 'Hero', icon: Star, cat: 'Layout', defaults: { heading: 'Big Bold Headline', subtext: 'Supporting text that explains the value proposition', btnText: 'Get Started', btnUrl: '#', bgColor: '#231f20', textColor: '#ffffff', btnColor: '#E6007E' } },
...
const TEMPLATES = [
  { name: 'Welcome Email', desc: 'Warm welcome for new clients', blocks: [
    ...
    { type: 'hero', data: { heading: 'Welcome to Koto!', subtext: "We're thrilled to have you as a client. Here's what happens next.", btnText: 'View Your Project', btnUrl: '#', bgColor: '#E6007E', textColor: '#ffffff', btnColor: '#ffffff' } },
    ...
    { type: 'button', data: { text: 'View Your Dashboard', url: '#', btnColor: '#E6007E', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 24, borderRadius: 8 } },
  ...
  { name: 'Design Ready', desc: 'Notify client designs are ready', blocks: [
    ...
    { type: 'button', data: { text: 'Review Designs Now', url: '#', btnColor: '#E6007E', textColor: '#ffffff', bgColor: '#ffffff', align: 'center', padding: 32, borderRadius: 8 } },
  ...
  { name: 'Monthly Newsletter', desc: 'Multi-section newsletter', blocks: [
    ...
    { type: 'hero', data: { heading: 'What We\'ve Been Working On', subtext: 'A look at our latest projects, tips, and updates', btnText: 'Read More', btnUrl: '#', bgColor: '#1a1a2e', textColor: '#ffffff', btnColor: '#E6007E' } },
