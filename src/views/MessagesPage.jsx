...
const TYPE_COLORS = { client: '#cb1c6b', internal: '#3b82f6', project: '#22c55e' }
        ...
        <MobilePage padded={false}>
          ...
          <div style={{padding:'10px 16px',background:'#fff',borderTop:'1px solid #ececea',display:'flex',gap:8}}>
            ...
            <button onClick={()=>sendMessage&&sendMessage()}
              style={{width:44,height:44,borderRadius:'50%',background:'#cb1c6b',border:'none',color:'#fff',display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer',flexShrink:0,WebkitTapHighlightColor:'transparent'}}>
