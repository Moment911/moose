    ...
    <div style={{ minHeight: '100vh', background: '#f9fafb' }}>
      ...
      <div style={{ maxWidth: 820, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <Section id="s1" title="1. Who We Are">
          ...
          <P>Lucy is a SaaS platform for marketing agencies providing project management, design review, email marketing, sales intelligence, and SEO/PPC analysis.</P>
        </Section>
        ...
        <Section id="s7" title="7. Your Rights and Choices">
          ...
          <UL items={['Go to Google Account → Security → Third-party apps → Remove Lucy', 'Disconnect from within Lucy\'s SEO Hub settings', 'Contact ' + email + ' for immediate revocation']} />
        ...
        <Section id="s10" title="10. Children's Privacy">
          <P>Lucy is not directed at children under 13 (or 16 in the EU). We do not knowingly collect information from children. Contact {email} if you believe we have.</P>
        </Section>
        ...
        <Section id="s12" title="12. Contact Us">
          ...
          <div style={{ marginTop: 20, padding: '16px 20px', background: '#FFF7ED', borderRadius: 10, border: '1px solid #FED7AA' }}>
            <p style={{ margin: 0, fontSize: 13, color: '#92400E', lineHeight: 1.6 }}><strong>For Google data access issues:</strong> Revoke Lucy's access directly through your <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" style={{ color: '#B45309', fontWeight: 600 }}>Google Account permissions page</a>.</p>
          </div>
        </Section>
