    ...
    <div className="flex h-screen overflow-hidden flex-col">
      ...
      <div className="text-white px-3 md:px-5 py-3 flex items-center gap-2 md:gap-4 flex-shrink-0" style={{ background: '#231f20' }}>
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="text-sm font-medium hidden md:inline">{project?.brand_name || 'Momenta Marketing'}</span>
        </div>
      ...
      {roundsExhausted && (
        <div className="text-white text-sm text-center py-3 font-medium flex-shrink-0 flex items-center justify-center gap-4" style={{ background: 'linear-gradient(135deg, #ea2729, #dc2626)' }}>
          ...
          <a href="https://www.momentamktg.com/contact" target="_blank" rel="noreferrer" className="bg-white text-brand-600 font-semibold text-xs px-4 py-1.5 rounded-lg hover:bg-gray-100 transition-colors">Contact Us</a>
          <a href="https://www.momentamktg.com/pricing" target="_blank" rel="noreferrer" className="bg-white/20 text-white font-medium text-xs px-4 py-1.5 rounded-lg hover:bg-white/30 transition-colors">View Pricing</a>
        </div>
      )}
          ...
          {!roundsExhausted ? (
            <div className="p-4 border-t-2 border-brand-200 bg-brand-50 flex-shrink-0">
              ...
              <p className="text-[10px] text-brand-600 text-center mt-2 font-medium">
                {unsubmittedCount > 0
                  ? `Click to review and submit your feedback to ${project?.brand_name || 'Momenta Marketing'}`
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 flex-shrink-0 text-center">
              ...
              <p className="text-[10px] text-gray-400 mt-1">Contact {project?.brand_name || 'Momenta Marketing'} for additional revisions</p>
            </div>
          )}
        </div>
      </div>
