...
- [x] 11-03-PLAN.md — Service inference + editable AI-flagged chips + target phrases (ONBOARD-04)
...
Plans:
- [x] 12-01-PLAN.md — Unified four-category extractor (Haiku + heuristic fallback) + saveConfirmedField generalization (WS1)
- [x] 12-02-PLAN.md — Multi-category editable chips (CategoryChips) + manual entry (WS2+WS4)
- [x] 12-03-PLAN.md — Synergy engine (Sonnet, graceful-degrade) + accept-able suggestion chips (WS3)
